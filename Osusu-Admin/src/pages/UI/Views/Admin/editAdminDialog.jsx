...
function EditAdminDialog({ open, onClose, admin, onAdminUpdated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // TODO: Implement actual admin update with Supabase
        ...
        <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
          ...
          <div className="space-y-3 lg:space-y-4">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => {
                  handleInputChange('changePassword', checked);
                  if (!checked) {
            ...
            {formData.changePassword && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-4 p-3 lg:p-4 bg-gray-50 rounded-lg">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className={`h-9 pr-10 ${errors.newPassword ? 'border-red-500' : ''}`}
                    />
                    <Button
                      type="button"
                      variant="ghost"
